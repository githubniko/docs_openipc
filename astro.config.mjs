...
export default defineConfig({
	...
	redirects: {
		...
		"/use-cases/fpv/wfb-ng/advanced-setup": "/use-cases/fpv-over-wfb-ng/advanced-setup/",
		...
		"/use-cases/fpv/wfb-ng/unbrick-eu-bu": "/use-cases/fpv-over-wfb-ng/unbrick-eu-bu/",
